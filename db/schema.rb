...
ActiveRecord::Schema[7.0].define(version: 2023_06_27_130104) do
  ...
  create_table "room_questions", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.integer "round"
    t.index ["question_id"], name: "index_room_questions_on_question_id"
    t.index ["room_id"], name: "index_room_questions_on_room_id"
  end
  ...
  create_table "user_answers", force: :cascade do |t|
    ...
    t.index ["room_id"], name: "index_user_answers_on_room_id"
  ...
  add_foreign_key "user_answers", "rooms"
